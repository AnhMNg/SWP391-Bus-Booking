        ...
        try {
            ...
            if (cn != null) {
                ...
                if (rs != null && rs.next()) {
                    ...
                    us = new User(id, rs.getNString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getInt(6), rs.getString(7), rs.getString(8), rs.getString(9),(rs.getString(10)));
    ...
    public static ArrayList<User> getListCustomer() throws SQLException {
        ...
        if (cn != null) {
            ...
            while (rs != null && rs.next()) {
                us = new User(rs.getInt(1), rs.getNString(2), rs.getNString(3), rs.getString(4), rs.getString(5), rs.getInt(6), rs.getString(7), rs.getString(8),rs.getString(9),(rs.getString(10)));
                list.add(us);
            }
            cn.close();
